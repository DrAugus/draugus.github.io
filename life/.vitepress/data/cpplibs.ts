        ...
        items: [
            ...
            },
            {
                ...
                desc: {
                    ...
                    repo: {
                        text: "Repo",
                        link: "https://github.com/actor-framework/actor-framework"
                    },
                    homepage: {
                        text: "Homepage",
                        link: "https://www.actor-framework.org/"
                    },
                    guide: {
                        text: "Guide",
                        link: "https://www.cafcademy.com/articles"
                    },
                    others: [
                        {
                            text: "Developer Blog",
...

            {
                ...
                desc: {
                    ...
                    repo: {
                        text: "Repo",
                        link: "https://github.com/zeromq/cppzmq"
                    },
                    homepage: {
                        text: "Homepage",
            ...
            },
            {
                ...
                desc: {
                    ...
                    repo: {
                        text: "Repo",
                        link: "https://github.com/libevent/libevent"
                    },
                    homepage: {
                        text: "Homepage",
                        link: "https://libevent.org/"
                    },
                    guide: {
                        text: "Guide",
                        link: "https://zguide.zeromq.org/"
            ...
            },
            {
                ...
                desc: {
                    ...
                    guide: {
                        text: "Guide",
                        link: "https://docs.libuv.org/en/v1.x/guide.html"
                    },
                },
            ...
            },
            {
                ...
                desc: {
                    ...
                    repo: {
                        text: "Repo",
                        link: "https://github.com/LuaJIT/LuaJIT"
                    },
                    homepage: {
                        text: "Homepage",
            ...
            },
            {
                ...
                desc: {
                    ...
                    repo: {
                        text: "Repo",
                        link: "https://github.com/Tencent/rapidjson/"
                    },
                    homepage: {
                        text: "Homepage",
