...
export const WISH: WishAll = {
  ...
  characters: [
    ...
    {
      name: ["Secretum Secretorum", "Born of Ocean Swell"],
      image: [2, 2],
      shortName: ["Albedo", "Eula"],
      start: "2021-11-24 06:00:00 +0800",
    ...
    {
      name: ["The Transcendent One Returns", "Invitation to Mundane Life"],
      image: [1, 2],
      shortName: ["Shenhe", "Xiao"],
      start: "2022-01-05 06:00:00 +0800",
    ...
    {
      name: ["Gentry of Hermitage", "Adrift in the Harbor"],
      image: [3, 2],
      shortName: ["Zhongli", "Ganyu"],
    ...
    },
    {
      ...
      image: [1],
      shortName: ["Yae Miko"],
      start: "2022-02-16 06:00:00 +0800",
    ...
    {
      name: ["Reign of Serenity", "Drifting Luminescence"],
      image: [2, 2],
      shortName: ["Raiden Shogun", "Sangonomiya Kokomi"],
    ...
    {
      name: ["Azure Excursion", "Ballad in Goblets"],
      image: [1, 3],
      shortName: ["Kamisato Ayato", "Venti"],
      start: "2022-03-30 06:00:00 +0800",
    ...
    {
      name: ["Discerner of Enigmas", "Invitation to Mundane Life"],
      image: [1, 3],
      shortName: ["Yelan", "Xiao"],
      start: "2022-05-31 06:00:00 +0800",
    ...
    {
      name: ["Leaves in the Wind", "Sparkling Steps"],
      image: [2, 3],
      shortName: ["Kaedehara Kazuha", "Klee"],
    ...
    {
      name: ["Viridescent Vigil", "Gentry of Hermitage"],
      image: [1, 4],
      shortName: ["Tighnari", "Zhongli"],
      start: "2022-08-24 06:00:00 +0800",
    ...
    {
      name: ["Adrift in the Harbor", "Drifting Luminescence"],
      image: [3, 3],
      shortName: ["Ganyu", "Sangonomiya Kokomi"],
    ...
    {
      name: ["Twilight Arbiter", "Ballad in Goblets"],
      image: [1, 4],
      shortName: ["Cyno", "Venti"],
      start: "2022-09-28 06:00:00 +0800",
    ...
    {
      name: ["Twirling Lotus", "Secretum Secretorum"],
      image: [1, 3],
      shortName: ["Nilou", "Albedo"],
    ...
    {
      name: ["The Moongrass' Enlightenment", "Tapestry of Golden Flames"],
      image: [1, 3],
      shortName: ["Nahida", "Yoimiya"],
      start: "2022-11-02 06:00:00 +0800",
    ...
    {
      name: ["Everbloom Violet", "Farewell of Snezhnaya"],
      image: [2, 4],
      shortName: ["Yae Miko", "Tartaglia"],
    ...
    {
      name: ["From Ashes Reborn", "Oni's Royale"],
      image: [1, 3],
      shortName: ["Wanderer", "Arataki Itto"],
      start: "2022-12-07 06:00:00 +0800",
    ...
    {
      name: ["Reign of Serenity", "Azure Excursion"],
      image: [3, 2],
      shortName: ["Raiden Shogun", "Kamisato Ayato"],
    ...
    {
      name: ["Caution in Confidence", "Invitation to Mundane Life"],
      image: [1, 4],
      shortName: ["Alhaitham", "Xiao"],
      start: "2023-01-18 06:00:00 +0800",
    ...
    {
      name: ["Moment of Bloom", "Discerner of Enigmas"],
      image: [3, 2],
      shortName: ["Hu Tao", "Yelan"],
    ...
    {
      name: ["Auric Blaze", "Twilight Arbiter"],
      image: [1, 2],
      shortName: ["Dehya", "Cyno"],
      start: "2023-03-01 06:00:00 +0800",
    ...
    {
      name: ["The Herons Court", "The Transcendent One Returns"],
      image: [3, 2],
      shortName: ["Kamisato Ayaka", "Shenhe"],
    ...
    {
      name: ["The Moongrass' Enlightenment", "Twirling Lotus"],
      image: [2, 2],
      shortName: ["Nahida", "Nilou"],
      start: "2023-04-12 06:00:00 +0800",
    ...
    {
      name: ["Immaculate Pulse", "Adrift in the Harbor"],
      image: [1, 4],
      shortName: ["Baizhu", "Ganyu"],
    ...
    {
      name: ["Tapestry of Golden Flames", "Everbloom Violet"],
      image: [4, 3],
      shortName: ["Yoimiya", "Yae Miko"],
      start: "2023-05-24 06:00:00 +0800",
    ...
    {
      name: ["Caution in Confidence", "Leaves in the Wind"],
      image: [2, 3],
      shortName: ["Alhaitham", "Kaedehara Kazuha"],
    ...
    {
      name: ["Born of Ocean Swell", "Sparkling Steps"],
      image: [3, 4],
      shortName: ["Eula", "Klee"],
      start: "2023-07-05 06:00:00 +0800",
    ...
    {
      name: ["Drifting Luminescence", "From Ashes Reborn"],
      image: [4, 2],
      shortName: ["Sangonomiya Kokomi", "Wanderer"],
    ...
    {
      name: ["Conjuring Chiaroscuro", "Discerner of Enigmas"],
      image: [1, 3],
      shortName: ["Lyney", "Yelan"],
      start: "2023-08-16 06:00:00 +0800",
    ...
    {
      name: ["Gentry of Hermitage", "Farewell of Snezhnaya"],
      image: [5, 5],
      shortName: ["Zhongli", "Tartaglia"],
    ...
    },
    {
      ...
      start: "2023-09-27 06:00:00 +0800",
    ...
    {
      name: ["Tempestuous Destiny", "Ballad in Goblets"],
      image: [1, 5],
    ...
    },
    {
      ...
      start: "2023-11-08 06:00:00 +0800",
    ...
    },
    {
      ...
      start: "2023-12-20 06:00:00 +0800",
    ...
    },
    {
      ...
      start: "2024-01-31 06:00:00 +0800",
  ...
  weapons: [
    ...
    },
    {
      ...
      wish5star: ['Cashflow Supervision', 'Elegy for the End'],
      wish4star: ["Prospector's Drill", 'Rainslasher', 'Eye of Perception'],
    },
    {
      name: "Epitome Invocation",
      image: 55,
