...
export const WISH: WishAll = {
  characters: [
    ...
    {
      name: ['Sunset Clause', 'Butterfly on Swordtip'],
      image: [1, 2],
  ...
  weapons: [
    ...
    },
    {
      ...
      shortName: "",
      wish5star: ["Brighter Than the Sun"],
      wish4star: ['Dance! Dance! Dance!', 'Planetary Rendezvous', "Landau's Choice"],
      url: ""
    },
    {
      name: "Brilliant Fixation",
    ...
    },
    {
      ...
      shortName: "",
      wish5star: ['I Shall Be My Own Sword'],
      wish4star: ['Memories of the Past', 'Make the World Clamor', 'Eyes of the Prey'],
      url: ""
    },
    {
      name: "Brilliant Fixation",
